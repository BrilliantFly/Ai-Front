...
const fallbackItems: NavItem[] = [
    {
        ...
        icon: '📋',
        selectedIcon: '📋',
        path: '/pages/knowledge/home/index',
        navType: 'switchTab',
        iconIsImage: false,
        sort: 1,
    ...
    },
    {
        ...
        icon: '📝',
        selectedIcon: '📝',
        path: '/pages/knowledge/memo/index',
        navType: 'switchTab',
        iconIsImage: false,
        sort: 2,
        fallbackKey: 'memo'
    ...
    },
    {
        ...
        icon: '📚',
        selectedIcon: '📚',
        path: '/pages/knowledge/list/index',
        navType: 'switchTab',
        iconIsImage: false,
        sort: 4,
...
const svgIconMap: Record<string, string> = {
    ...
    memo: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>`,
...
const inferFallbackKey = (menuCode: string, menuName: string, path: string) => {
    ...
    if (code.includes('customer') || name.includes('客户') || path.includes('/pages/customer/'))
        return 'customer'
    if (code.includes('workspace') || name.includes('工作台') || path.includes('/pages/knowledge/home/index'))
        return 'workspace'
    if (code.includes('memo') || name.includes('小记') || path.includes('/pages/knowledge/memo/index'))
        return 'memo'
    if (code.includes('knowledge') || name.includes('知识库') || path.includes('/pages/knowledge/list/index'))
        return 'knowledge'
    if (
...
const TAB_PAGE_PATHS = ['/pages/index/index', '/pages/news/news', '/pages/user/user', '/pages/knowledge/home/index', '/pages/knowledge/list/index', '/pages/knowledge/memo/index'] as const
...
const FALLBACK_PATH_MAP: Record<string, string> = {
    ...
    workspace: '/pages/knowledge/home/index',
    knowledge: '/pages/knowledge/list/index',
    memo: '/pages/knowledge/memo/index'
}
